...
let DEFAULT: InstanceType<typeof TEAM>

function updateTEAM(team: InstanceType<typeof TEAM>) {
    team.setColor(core.type("org.bukkit.ChatColor").WHITE)
    team.setAllowFriendlyFire(true)
    team.setOption(TEAMO.NAME_TAG_VISIBILITY, TEAMOS.NEVER)
}

if(scoreBoard.getTeam("default")) {DEFAULT = scoreBoard.getTeam("default"); updateTEAM(DEFAULT);}
else DEFAULT = scoreBoard.registerNewTeam("default"); updateTEAM(DEFAULT);
